...
$stmt = $conn->prepare("SELECT student_id, route3_id FROM route3final_files WHERE adviser_id = ?");
if ($stmt === false) {
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="content" id="content-area">
                <?php
                $stmt = $conn->prepare("SELECT docuRoute3, student_id, route3_id FROM route3final_files WHERE adviser_id = ?");
                $stmt->bind_param("s", $adviser_id);
                $stmt->execute();
                $result = $stmt->get_result();
