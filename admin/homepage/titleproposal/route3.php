...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['delete_file'])) {
    ...
    $deleteStmt = $conn->prepare("DELETE FROM route3proposal_files WHERE route3_id = ?");
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['update_assignments'])) {
    ...
    $updateStmt = $conn->prepare("UPDATE route3proposal_files 
...
<div><strong>Feedback</strong></div>div>
