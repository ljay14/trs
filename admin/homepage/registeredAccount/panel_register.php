...
$sql = "SELECT fullname, department, school_id FROM panel ORDER BY fullname ASC";
        ...
        <nav class="sidebar">
            ...
            <div class="content">
                <div class="form-container">
                        ...
                        <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        <form action="update_panel_inline.php" method="POST">
                                            <td>
                    ...
                    <?php else: ?>
                        <p>No Panelist have been registered yet.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
