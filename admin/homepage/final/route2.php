...
// Fetch school years
$schoolYears = [];
$schoolYearQuery = "SELECT DISTINCT school_year FROM route2final_files ORDER BY school_year DESC";
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['update_assignments'])) {
    ...
    $updateStmt = $conn->prepare("UPDATE route2final_files 
