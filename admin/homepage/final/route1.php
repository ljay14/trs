        ...
        foreach ($selectedFiles as $filePath) {
            ...
            if ($fileExists) {
                ...
                $updatePanelStmt = $conn->prepare("UPDATE route1final_files 
                    ...
                    WHERE docuRoute1 = ?");
                $updatePanelStmt->bind_param("iiisss", $panel1, $panel2, $panel3, $panel4, $dateNow, $fileName);
                            ...
                            <?php if (!empty($files)): ?>
                                <?php foreach ($files as $file): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <button type="button" class="view-button" onclick="viewFile('<?= $filepath ?>', '<?= $student_id ?>', '<?= $route1_id ?>')">View</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
