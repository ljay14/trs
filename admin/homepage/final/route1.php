...
<body>
    ...
    <form id="submission-form" action="route1.php" method="POST" style="width: 100%; max-width: 1200px;">
...
document.getElementById("external-submit-button").addEventListener("click", function () {
    ...
    // Validate at least one panelist is selected and an adviser is select
