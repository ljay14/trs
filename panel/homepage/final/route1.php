    ...
    try {
        ...
        $mail->Body = "
            <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;'>
                ...
                <p>Your panel member <strong>{$panel_name}</strong> has submitted feedback on your thesis final.</p>
        ...
        ";
        $mail->AltBody = "Dear {$student_name}, Your panel member {$panel_name} has submitted feedback on your thesis final. Feedback Summary: {$feedback_summary}. Please login at: {$login_url} to review the detailed feedback.";
