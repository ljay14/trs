...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['dateSubmitted'])) {
    ...
    // Prepare the query
    $stmt = $conn->prepare("INSERT INTO proposal_monitoring_form (panel_id, panel_name, date_submitted, chapter, feedback, paragraph_number, page_number, date_released, docuRoute3, route3_id, student_id) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="content" id="content-area">
                <?php
                $query = "
                SELECT docuRoute3, department, student_id, route3_id 
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        $filePath = $row['docuRoute3']; // This is the path to the file
                        $route3_id = $row['route3_id'];
                        $student_id = $row['student_id'];
                        ...
                        <div class='file-preview'>
                            ...
                            <button onclick=\"viewFile('$filePath', '$route3_id', '$student_id')\">View File</button>
                        </div>
                        ";
                    }
