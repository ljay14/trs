...
function sendAdviserNotificationEmail($adviser_email, $adviser_name, $fullname, $title) {
    try {
        ...
        $emailData = [
            ...
            'subject' => 'New Final Defense Document (Final Document) Submitted for Review',
            'body' => "
            ...
            ",
            'alt_body' => "Dear {$adviser_name}, A new final defense document (Final Document) has been submitted by {$fullname} with the title '{$title}' and requires your review. Please login at: https://capstone.smccnasipit.edu.ph/trs/adviser/login.php",
